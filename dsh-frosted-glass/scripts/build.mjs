 ...
 *
 * The free `module` variable inside the CJS output binds to the wrapper's
 * `var module = { exports: {} }`, so esbuild's final
 * `module.exports = __toCommonJS(...)` lands on the loader's module record.
 */
...
await build({
  ...
  target: ["es2022"],
  jsx: "automatic",
  // Everything the module loader table resolves at runtime stays external.
